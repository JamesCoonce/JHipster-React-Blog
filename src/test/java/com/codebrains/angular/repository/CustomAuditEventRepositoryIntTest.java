...
import com.codebrains.angular.config.audit.AuditEventConverter;
import com.codebrains.angular.domain.PersistentAuditEvent;
...
import static com.codebrains.angular.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
