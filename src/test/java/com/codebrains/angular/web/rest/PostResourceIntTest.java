...
import com.codebrains.angular.domain.Post;
import com.codebrains.angular.repository.PostRepository;
...
public class PostResourceIntTest {
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.isPublished()).isEqualTo(DEFAULT_PUBLISHED);
        assertThat(testPost.getDatecreated()).isEqualTo(DEFAULT_DATECREATED);
    }
    ...
    public void updatePost() throws Exception {
        ...
        assertThat(testPost.isPublished()).isEqualTo(UPDATED_PUBLISHED);
        assertThat(testPost.getDatecreated()).isEqualTo(UPDATED_DATECREATED);
    }
